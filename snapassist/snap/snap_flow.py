...
class SnapFlow:
    ...
    def cancel(self) -> None:
        ...
        self._ui_manager.send_command({"action": "hide_snap_assist"})
    ...
    def confirm_selection(self, layout_index: int, zone_index: int) -> None:
        ...
        def on_complete():
            ...
            self._snap_engine.snap_window_to_rect(
                wid_to_animate,
    ...
    def confirm_assist_selection(self, wid: Optional[int]) -> None:
        """Acopla una sugerencia y continúa con la siguiente zona vacía."""
        if not wid or not self._is_active or self._phase != "assist":
            return
    ...
    def cancel_snap_assist(self, reason: str = "escape") -> None:
